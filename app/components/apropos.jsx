...
const AboutUs = () => {
  ...
  useEffect(() => {
    ["hero", "features", "advantages", "founder", "contact"].forEach(
      fadeInOnScroll
    );
  }, []);

  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-slate-900 to-indigo-950 text-white relative overflow-hidden">
      {/* Background Effects */}
      ...
      <header className="relative z-10 p-6 border-b border-white/10 bg-black/20 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <button className="bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 px-6 py-2 rounded-xl font-semibold transition-all duration-300 hover:scale-105">
            Retour au Dashboard
          </button>
        </div>
      </header>
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8">
            ...
            plusieurs utilisateurs de regarder des films ensemble à distance,
            tout en discutant en temps réel via chat ou appel vidéo.{" "}
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    collaboratives en ligne, j'ai créé CinéSync pour résoudre un
                    problème que nous avons tous vécu :
                    <span className="text-white font-semibold">
                      {" "}
                      regarder des films ensemble à distance sans se prendre la
                      tête
                    </span>
                    .
                  </p>
                  ...
                  <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 p-4 rounded-xl border border-purple-500/20">
                    <p className="text-purple-300 text-sm italic">
                      💡 "L'idée est née pendant le confinement, quand regarder
                      un film avec des amis devenait un vrai casse-tête
                      technique. J'ai voulu créer LA solution simple et
                      élégante."
                    </p>
                  </div>
              ...
              <div className="text-center">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-cyan-500/20 p-4 rounded-xl border border-cyan-500/30">
                    <div className="text-2xl font-bold text-cyan-300">2024</div>
        ...
        >
          <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 p-8 rounded-3xl border border-cyan-500/20">
            ...
            <p className="text-gray-300 mb-8">
              Une question ? Une suggestion ? Une collaboration ? N'hésitez pas
              !
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <div className="group flex items-center space-x-3 bg-purple-500/20 px-6 py-3 rounded-xl border border-purple-500/30">
                ...
                <span className="text-white font-semibold">GitHub (Privé)</span>
              </div>
            </div>
      ...
      <footer className="relative z-10 text-center text-sm text-gray-500 py-8 border-t border-white/10 bg-black/20 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p>© 2024 Mohamed Belghieti • Tous droits réservés • Version Bêta</p>
        </div>
      </footer>
    </div>
  );
